...
var colors, fs, getCompiler, getUUID, messenger, nodefncall, sequence, start;
...
messenger = function(msg, next) {
  ...
  switch (title) {
    case 'objective::start':
      ...
      console.log(output);
      break;
    case 'missing or broken realizer':
...
start = function(context, notice, moduleFn, taskCallback) {
  ...
  context.tools.monitor.directory(notice, context.src, function(placeholder, file, stat) {
    ...
    return done.then(function(res) {
      ...
      return taskCallback(context.realizers.task('run', {
        uuid: uuid,
        script: specfile,
        module: 'ipso',
        "class": 'spec',
